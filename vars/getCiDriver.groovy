...
class CiDriver {
  ...
  private submit_info        = [:]
  private ChangeRequest change = null
  ...
  private config_file
  private scm_api_credential_id  = null
  ...
  CiDriver(Map params = [:], steps, String repo, printMetrics) {
    ...
    this.scm_api_credential_id = params.getOrDefault('scm_api_cred_id', params.getOrDefault('bb_api_cred_id', 'tt_service_account_creds'))
    this.scm = [
